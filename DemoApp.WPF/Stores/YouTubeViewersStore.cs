...
namespace DemoApp.WPF.Stores
{
    public class YouTubeViewersStore
    {
        ...
        public YouTubeViewersStore(IGetAllYouTubeViewersQuery addYouTubeViewerQuery, 
        ...
        {
            _getAllYouTubeViewerQuery = addYouTubeViewerQuery;
        ...
        {
            IEnumerable<YouTubeViewer> youTubeViewers = await _getAllYouTubeViewerQuery.Execute();
